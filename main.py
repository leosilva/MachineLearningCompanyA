        ...
        for inst in param_dict['smote_instances']:
            for sca in param_dict['scales']:
                ...
                for feat in features:
                    ...
                    for item in models.items():
                        ...
                        for f in param_dict['folds']:
                            ...
                            for train_index, test_index in cv.split(X, y):
                                ...
                                test_predictions = best_model.predict(X_test_cv)
                                class_report_dict_test = classification_report(y_test_cv.astype('int'), test_predictions, output_dict=True)
                    ...
                    ut.save_df_to_csv(result_df, d, inst, sca, count)
